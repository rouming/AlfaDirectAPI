...
public:
    ...
    virtual bool loadContext ( const void* pCertContext, unsigned int* provContext ) = 0;
    virtual bool unloadContext ( unsigned int provContext ) = 0;
    virtual bool makeSignature ( unsigned int provContext, const void* pCertContext, const char* szData, unsigned int cDataSize, char** pszResultData, unsigned int* pcResultSize ) = 0;
